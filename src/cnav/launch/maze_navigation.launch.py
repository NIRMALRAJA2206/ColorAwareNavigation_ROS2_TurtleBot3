...
def generate_launch_description():
    ...
    maze_path = os.path.join(get_package_share_directory('cnav'),'world','maze','model.sdf')
    config_dir = os.path.join(get_package_share_directory('cnav'),'config')
    ...
    launch_arguments={
        ...
        # ----------- NEW --------------
        'cmd_vel_out_topic': '/cmd_vel_nav'   # <-- this line
    }.items()
